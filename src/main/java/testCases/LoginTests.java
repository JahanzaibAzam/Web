...
public class LoginTests extends BaseTest {
    ...
    public static void SampleTestCase() throws InterruptedException {
        logStep("User is logged in successfully");
        System.out.println("TestCase 01");
        Assert.assertEquals(1,1);
        GenericFunctions.PercyCapture("SampleTestCase");
...
//        actions.keyDown(Keys.CONTROL).sendKeys(Keys.END).perform();
        ...
        Thread.sleep(5000);
        GenericFunctions.PercyCapture("Scroller");
